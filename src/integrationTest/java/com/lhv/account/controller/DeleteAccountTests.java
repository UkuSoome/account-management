...
public class DeleteAccountTests extends AbstractIntegrationTest {
    @LocalServerPort
    private int port;
    ...
    void shouldDeleteExistingAccount() {
        AccountResponse created = createTestAccount(client, "Bob", "+37251234568");
        ...
        Assertions.assertEquals(created.getId(), deleted.getId());
        Assertions.assertEquals("DELETED", deleted.getAction().name());
    }
